          ...
          <div class="col px-0">
            <div class="row align-items-center justify-content-center">
              <div class="col-lg-8 text-center">
                <h1 class="text-white display-1">Welcome to ATM Library</h1>
                <h2 class="display-4 font-weight-normal text-white">Membaca adalah gudangnya ilmu</h2>
                <div class="btn-wrapper mt-4">
                  <a href="#daftarebook" class="btn btn-warning btn-icon mt-3 mb-sm-0">
                    <span class="btn-inner--icon"><i class="ni ni-button-play"></i></span>
                    <span class="btn-inner--text">Jelajahi</span>
                  </a>
                </div>
              </div>
            </div>
